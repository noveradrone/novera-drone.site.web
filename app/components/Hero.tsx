...
export default function Hero({
  ...
  const titleClass =
    overlayPreset === "cinematic"
      ? "max-w-4xl text-4xl font-semibold leading-[1.02] tracking-[0.04em] text-white [text-shadow:0_10px_28px_rgba(2,6,23,0.8)] sm:text-6xl sm:tracking-[0.06em] md:text-8xl"
